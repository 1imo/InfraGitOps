...
public class UfwWorkflowOrchestration : IWorkflowOrchestration
{
    ...
    public UfwWorkflowOrchestration(
        IApplier applier,
    ...
    {
        Console.WriteLine($"[UfwWorkflowOrchestration] Starting workflow for {ComponentName}");
    ...
    private async Task<object> ProcessTransformersAsync(object manifestData)
    {
        ...
        {
            Console.WriteLine($"[UfwWorkflowOrchestration] Running transformer: {transformer.SourceComponent} → {transformer.TargetComponent}");
